# JeecgBoot AI Agent协作文件命名规范 v5.0
...
- **AGENT**: Agent代码 (REQ|ARCH|DEV|TEST)
- **TITLE**: 功能标题 (4-8个中文字符)
...
**版本历史**:
- v5.0 (2025-08-04): AI协作优化版本，简化命名规范
- v4.1 (2025-08-04): AI友好性优化，模块化设计
